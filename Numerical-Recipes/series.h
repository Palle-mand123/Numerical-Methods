...
struct Eulsum {
  ...
  Eulsum(Int nmax, Doub epss)
      : wksp(nmax), n(0), ncv(0), cnvgd(0), sum(0.), eps(epss), lastval(0.) {}
...
struct Epsalg {
  ...
  Epsalg(Int nmax, Doub epss)
      : e(nmax), n(0), ncv(0), cnvgd(0), eps(epss), lastval(0.) {
...
struct Levin {
  ...
  Levin(Int nmax, Doub epss)
      : numer(nmax), denom(nmax), n(0), ncv(0), cnvgd(0), eps(epss),
        lastval(0.) {
    small = numeric_limits<Doub>::min() * 10.0;
    big = numeric_limits<Doub>::max();
  }
