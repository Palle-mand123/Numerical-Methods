...
struct Spline_interp : Base_interp {
  ...
  Spline_interp(VecDoub_I &xv, VecDoub_I &yv, Doub yp1 = 1.e99,
                Doub ypn = 1.e99)
      : Base_interp(xv, &yv[0], 2), y2(xv.size()) {
    sety2(&xv[0], &yv[0], yp1, ypn);
  }

  Spline_interp(VecDoub_I &xv, const Doub *yv, Doub yp1 = 1.e99,
                Doub ypn = 1.e99)
...
Doub BaryRat_interp::interp(Doub x) { return rawinterp(1, x); }
#endif //
