#ifndef _STATTESTS_H_
#define _STATTESTS_H_
#include "erf.h"
...
void chsone(VecDoub_I &bins, VecDoub_I &ebins, Doub &df, Doub &chsq, Doub &prob,
            const Int knstrn = 1) {
  Gamma gam;
...
void chstwo(VecDoub_I &bins1, VecDoub_I &bins2, Doub &df, Doub &chsq,
            Doub &prob, const Int knstrn = 1) {
  Gamma gam;
...
void kendl1(VecDoub_I &data1, VecDoub_I &data2, Doub &tau, Doub &z,
            Doub &prob) {
