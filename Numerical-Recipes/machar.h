...
struct Machar {
  ...
  void report() {
    ...
    cout << "radix:  " << numeric_limits<Doub>::radix << "  (" << ibeta << ")"
         << endl;
    cout << "mantissa digits:  " << numeric_limits<Doub>::digits << "  (" << it
         << ")" << endl;
    cout << "round style:  " << numeric_limits<Doub>::round_style << "  ("
         << irnd << ") [our 5 == IEEE 1]" << endl;
    cout << "guard digits:  " << "[not in numeric_limits]"
         << "  (" << ngrd << ")" << endl;
    cout << "epsilon:  " << numeric_limits<Doub>::epsilon() << "  (" << eps
         << ")" << endl;
    ...
    cout << "max exponent:  " << numeric_limits<Doub>::max_exponent << "  ("
         << maxexp << ")" << endl;
    cout << "minimum:  " << numeric_limits<Doub>::min() << "  (" << xmin << ")"
         << endl;
    cout << "maximum:  " << numeric_limits<Doub>::max() << "  (" << xmax << ")"
         << endl;
  }
};
#endif //
