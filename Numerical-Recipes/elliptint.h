#ifndef _ELLIPTINT_H_
#define _ELLIPTINT_H_
#include "nr3.h"
Doub rc(const Doub x, const Doub y) {
  static const Doub ERRTOL = 0.0012, THIRD = 1.0 / 3.0, C1 = 0.3,
                    C2 = 1.0 / 7.0, C3 = 0.375, C4 = 9.0 / 22.0;
...
Doub rd(const Doub x, const Doub y, const Doub z) {
  static const Doub ERRTOL = 0.0015, C1 = 3.0 / 14.0, C2 = 1.0 / 6.0,
                    C3 = 9.0 / 22.0, C4 = 3.0 / 26.0, C5 = 0.25 * C3,
                    C6 = 1.5 * C4;
  static const Doub TINY = 2.0 * pow(numeric_limits<Doub>::max(), -2. / 3.),
                    BIG = 0.1 * ERRTOL *
                          pow(numeric_limits<Doub>::min(), -2. / 3.);
...
Doub rf(const Doub x, const Doub y, const Doub z) {
  static const Doub ERRTOL = 0.0025, THIRD = 1.0 / 3.0, C1 = 1.0 / 24.0,
                    C2 = 0.1, C3 = 3.0 / 44.0, C4 = 1.0 / 14.0;
  static const Doub TINY = 5.0 * numeric_limits<Doub>::min(),
                    BIG = 0.2 * numeric_limits<Doub>::max();
...
Doub rj(const Doub x, const Doub y, const Doub z, const Doub p) {
  static const Doub ERRTOL = 0.0015, C1 = 3.0 / 14.0, C2 = 1.0 / 3.0,
                    C3 = 3.0 / 22.0, C4 = 3.0 / 26.0, C5 = 0.75 * C3,
  ...
  Doub a, alamb, alpha, ans, ave, b, beta, delp, delx, dely, delz, ea, eb, ec,
