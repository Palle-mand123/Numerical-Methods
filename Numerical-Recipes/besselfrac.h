...
const Doub Bessel::c1[7] = {-1.142022680371168e0,
                            6.5165112670737e-3,
                            3.087090173086e-4,
                            -3.4706269649e-6,
                            6.9437664e-9,
...
void Bessel::besseljy(const Doub nu, const Doub x) {
  ...
  Doub a, b, br, bi, c, cr, ci, d, del, del1, den, di, dlr, dli, dr, e, f, fact,
      fact2, fact3, ff, gam, gam1, gam2, gammi, gampl, h, p, pimu, pimu2, q, r,
      rjl, rjl1, rjmu, rjp1, rjpl, rjtemp, ry1, rymu, rymup, rytemp, sum, sum1,
...
void Bessel::airy(const Doub x) {
  static const Doub PI = 3.141592653589793238, ONOVRT = 0.577350269189626,
                    THR = 1. / 3., TWOTHR = 2. * THR;
  Doub absx, rootx, z;
  absx = abs(x);
  rootx = sqrt(absx);
  z = TWOTHR * absx * rootx;
