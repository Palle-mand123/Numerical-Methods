#ifndef _FOURIER_NDIM_H_
#define _FOURIER_NDIM_H_
#include "nr3.h"
...
void rlft3(Doub *data, Doub *speq, const Int isign, const Int nn1,
           const Int nn2, const Int nn3) {
...
void rlft3(Mat3DDoub_IO &data, MatDoub_IO &speq, const Int isign) {
  ...
  rlft3(&data[0][0][0], &speq[0][0], isign, data.dim1(), data.dim2(),
        data.dim3());
}
