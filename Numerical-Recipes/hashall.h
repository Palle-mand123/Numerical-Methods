...
void psdes(Uint &lword, Uint &rword) {
  const int NITER = 2;
  static const Uint c1[4] = {0xbaa96887L, 0x1e17d32cL, 0x03bcdc3cL,
                             0x0f33d1b2L};
  static const Uint c2[4] = {0x4b0f3b58L, 0xe874f0c3L, 0x6955c5a6L,
                             0x55a7ca46L};
  ...
  for (i = 0; i < NITER; i++) {
    ...
    rword = lword ^ (((ia = (ib >> 16) | ((ib & 0xffff) << 16)) ^ c2[i]) +
                     itmpl * itmph);
    lword = iswap;
  }
}
